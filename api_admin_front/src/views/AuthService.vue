<template>
  ...
  export default defineComponent({
    ...
    setup() {
      ...
      // Извлекаем service_name из query параметра
      ...
      const submitVerificationCode = async () => {
        try {
          ...
          // Сохраняем токен в хранилище в зависимости от выбранной опции
          if (form.rememberMe) {
          ...
          // После успешной авторизации перенаправляем на ту страницу, откуда пришел пользователь
          const redirectUrl = route.query.redirect || '/';  // Если redirect отсутствует, перенаправим на главную страницу
